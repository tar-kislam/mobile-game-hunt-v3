 ...
 * Run with: node scripts/test-username-generation.js
 */

import { generateUniqueUsername, isUsernameAvailable, sanitizeUsername } from '../src/lib/usernameUtils.js'
...
async function testUsernameGeneration() {
  ...
  try {
    ...
    console.log(`  Collision test failed: ${error.message}`)
  }
