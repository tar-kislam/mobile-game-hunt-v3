...
export function EnhancedProductDetail({ product, hasVoted, session }: EnhancedProductDetailProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      {/* H1 Heading for SEO - Small and unobtrusive */}
      <h1 className="text-lg font-semibold text-white mb-4 opacity-80">
        {product.title}
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          {product.socialLinks && (
            ...
            >
            <Card className="rounded-3xl shadow-soft border-2 bg-gradient-to-br from-gray-900/80 via-black/70 to-gray-900/80 backdrop-blur-xl border-gray-800/50 shadow-lg relative overflow-hidden">
              <CardHeader className="pb-4">
