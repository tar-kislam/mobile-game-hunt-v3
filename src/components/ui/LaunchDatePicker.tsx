...
export function LaunchDatePicker({
  ...
  const validateDate = useCallback((date: Date): boolean => {
    // Allow all valid dates - past, present, and future
    return true
  }, [])
  ...
  const renderCalendar = () => {
    ...
    const isPastDate = (day: number) => {
      // Allow all dates - no past date restrictions
      return false
    }
    ...
    <div className="relative">
      <div className="relative">
        <input
          ...
          className={cn(
            "w-full bg-black/30 border border-neutral-700/70 text-white rounded-md p-3 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400 placeholder-gray-500 transition-all duration-200",
        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
          ...
          <button
            ...
            disabled={disabled}
            className="h-8 w-8 flex items-center justify-center text-gray-400 hover:text-purple-400 hover:bg-purple-500/10 rounded-md transition-all duration-200"
