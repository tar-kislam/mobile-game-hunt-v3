...
export function GogGameCard({ game, onVote }: GogGameCardProps) {
  ...
  return (
    <Link href={`/product/${game.id}`}>
      <Card className="group h-full flex flex-col bg-transparent hover:bg-card/20 transition-all duration-300 border-0 hover:border-purple-500/30 rounded-lg overflow-hidden hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-500/20">
