...
-- CreateEnum
CREATE TYPE "public"."NotificationType" AS ENUM ('COMMENT', 'MENTION', 'PRODUCT_APPROVED', 'UPVOTE');
...
-- CreateIndex
CREATE UNIQUE INDEX "Vote_userId_productId_key" ON "public"."Vote"("userId", "productId");
...
-- AddForeignKey
ALTER TABLE "public"."Vote" ADD CONSTRAINT "Vote_productId_fkey" FOREIGN KEY ("productId") REFERENCES "public"."Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
